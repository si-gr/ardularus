...
BUILD_OPTIONS = [
    ...
    Feature('Sensors', 'RPM_GENERATOR', 'AP_RPM_GENERATOR_ENABLED', 'Enable RPM Pin-based sensors', 0, 'RPM,GENERATOR'),
    ...
    Feature('Airspeed Drivers', 'DLLR', 'AP_AIRSPEED_DLLR_ENABLED', 'ENABLE DLLR AIRSPEED', 0, 'AIRSPEED'),
